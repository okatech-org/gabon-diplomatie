...
> = {
  administrative: { label: "Administratif", variant: "default" },
  travel: { label: "Voyage", variant: "secondary" },
  entrepreneurship: { label: "Entrepreneuriat", variant: "outline" },
  practical_life: { label: "Vie pratique", variant: "secondary" },
  culture: { label: "Culture", variant: "outline" },
};
...
const typeConfig: Record<
  ...
  { label: string; variant: "default" | "secondary" | "outline" }
> = {
  video: { label: "Vidéo", variant: "default" },
  article: { label: "Article", variant: "secondary" },
  guide: { label: "Guide", variant: "outline" },
};

export const tutorialsColumns: ColumnDef<Tutorial>[] = [
  {
    accessorKey: "title",
    header: "Titre",
    cell: ({ row }) => (
    ...
    cell: ({ row }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <a
              href={`/academy/${row.original.slug}`}
              target="_blank"
